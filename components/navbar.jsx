...
const Navbar = () => {
  ...
  return (
    <div
      className={`lg:h-[3rem] flex  lg:items-center lg:p-5 lg:mt-5 font-epilogue justify-between lg:justify-normal lg:bg-[#FAFAFA]  ${
        !menu ? "bg-[#4B4B4B]" : "bg-[#FAFAFA]"
      }`}
    >
      <div className="text-4xl font-bold mb-2 ms-5 lg:ms-0">snap</div>
      {!menu ? (
        <div className="flex flex-col h-screen  w-2/5 lg:hidden bg-white  ">
          <div
            className="flex justify-end me-5 mt-5 cursor-pointer"
            onClick={handleClick}
          >
            <Image src="./images/icon-close-menu.svg" width={20} height={20} />
          </div>
